...
$assert(
    ...
    'Le intestazioni devono restare ordinabili anche quando la tabella dati Ã¨ vuota.'
);
$assert(
...
$assert(str_contains($css, '.topbar-search') && str_contains($css, '.professional-section') && str_contains($css, '@media(prefers-reduced-motion:reduce)'), 'Design system professionale o accessibilitÃƒÂ  CSS incompleti.');
