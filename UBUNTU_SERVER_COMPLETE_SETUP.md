...
```bash
# Crea file .env (se non esiste già)
cp .env.example .env
...
MYSQL_USER=luna2
MYSQL_PASSWORD=YourStrongLuna2Password456!
...
ADMIN_PASS=YourAdminPassword789!
```

**⚠️ IMPORTANTE: Cambia TUTTE le password con valori sicuri!**
...
tar -czf $BACKUP_DIR/luna2-config-$DATE.tar.gz \
    /home/luna2/Luna2/server-manager/.env \
    /home/luna2/Luna2/.env

# Backup database domains config
cp /home/luna2/Luna2/domains-config.txt $BACKUP_DIR/domains-config-$DATE.txt
