...
-- ============================================================
INSERT IGNORE INTO fatture_passive (id, numero, anno, data_fattura, fornitore_id, fornitore_nome, fornitore_piva, oggetto, imponibile, iva, totale, stato_pagamento, data_scadenza, data_pagamento, metodo_pagamento, data_creazione, data_modifica, created_by) VALUES
...
-- 12. PAGAMENTI
-- ============================================================
INSERT IGNORE INTO pagamenti (id, fattura_id, importo, data_pagamento, metodo_pagamento, riferimento, banca_mittente, causale, riconciliato, data_riconciliazione, data_creazione, data_modifica, created_by) VALUES
...
-- ============================================================
INSERT IGNORE INTO movimenti_magazzino (id, prodotto_id, tipo_movimento, causale, quantita, costo_unitario, giacenza_prima, giacenza_dopo, documento_tipo, documento_numero, data_movimento, data_creazione, created_by) VALUES
...
-- 14. LIQUIDAZIONI IVA
-- ============================================================
INSERT IGNORE INTO iva_liquidations (id, liquidation_period, liquidation_date, end_date, period_type, iva_invoices_amount, iva_costs_amount, net_iva_amount, deductible_credits_amount, amount_due, due_date, status, notes, created_at, updated_at) VALUES
-- Gennaio 2026
...
-- ============================================================
INSERT IGNORE INTO accounting_accounts (id, code, name, category, system_account, enabled, description, created_at, updated_at) VALUES
-- ATTIVO
...
-- ============================================================
INSERT IGNORE INTO accounting_entries (id, protocol_number, entry_date, competence_date, type, status, description, document_number, source_type, source_id, counterparty, total_debit, total_credit, notes, created_by, created_at, updated_at) VALUES
...
-- ============================================================
INSERT IGNORE INTO accounting_entry_lines (id, entry_id, account_id, line_type, amount, description) VALUES
