...
| Pagamenti, partite, banche e riconciliazione | Operativo | Allocazioni, insoluti, storni e matching controllato |
...
La release PHP contiene tutti i workflow applicativi sopra elencati e la migrazione `008_full_erp_parity.sql`. Non sostituisce le attività che dipendono da terze parti o da responsabilità professionali:
