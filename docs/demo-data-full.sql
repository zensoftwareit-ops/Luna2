-- ============================================================
-- Luna2 – Dati di esempio COMPLETI + CONTABILITÀ
-- Include complete journal entries and accounting
-- ============================================================

SET FOREIGN_KEY_CHECKS = 0;

-- ============================================================
-- Esecuzione script in 3 step:
-- 1. Pulire tabelle
-- 2. Caricare questo script
-- 3. Verificare i dati
-- ============================================================
...
-- ============================================================
-- 4. PREVENTIVI, ORDINI, FATTURE, ECC.
-- (Copy all from demo-data-extended.sql, skipping for brevity)
-- ============================================================
...
-- ============================================================
INSERT INTO accounting_entries (id, protocol_number, entry_date, competence_date, type, status, description, document_number, source_type, source_id, counterparty, total_debit, total_credit, notes, created_by) VALUES
-- Fattura Attiva #1
(1, 'GEN-2026-001', '2026-01-27', '2026-01-27', 'FATTURA_ATTIVA', 'POSTED', 'Fattura FT-2026-001 – Clienti conto vendite', 'FT-2026-001', 'FATTURA', 1, 'Alfa Informatica', 1889.78, 1889.78, 'Contabilizzazione vendita notebook e software', 1),
-- Fattura Attiva #2
(2, 'FEB-2026-001', '2026-02-28', '2026-02-28', 'FATTURA_ATTIVA', 'POSTED', 'Fattura FT-2026-002 – Hosting cloud', 'FT-2026-002', 'FATTURA', 2, 'Beta Consulting', 242.78, 242.78, 'Contabilizzazione servizio hosting', 1),
-- Incasso Fattura 1
(3, 'GEN-2026-002', '2026-02-20', '2026-02-20', 'INCASSO', 'POSTED', 'Incasso Bonifico – Fattura FT-2026-001', 'RIF-BNK-001', 'PAGAMENTO', 1, 'Alfa Informatica', 1889.78, 1889.78, 'Riscossione bonifico bancario', 1),
-- Fattura Passiva #1
(4, 'GEN-2026-003', '2026-01-15', '2026-01-15', 'FATTURA_PASSIVA', 'POSTED', 'Fattura FP-2026-001 – Acquisto Notebook', 'FP-2026-001', 'FATTURA_PASSIVA', 1, 'HP Inc Italia', 7869.00, 7869.00, 'Contabilizzazione acquisto hardware', 1),
-- Pagamento Fattura Passiva 1
(5, 'FEB-2026-002', '2026-02-10', '2026-02-10', 'PAGAMENTO', 'POSTED', 'Pagamento Bonifico – Fattura FP-2026-001', 'RIF-BNK-005', 'PAGAMENTO', 2, 'HP Inc Italia', 7869.00, 7869.00, 'Versamento bonifico bancario', 1),
-- IVA Liquidazione Gennaio
(6, 'FEB-2026-003', '2026-02-10', '2026-02-10', 'TRIBUTO', 'POSTED', 'Liquidazione IVA Gennaio 2026 – Versamento', 'LIQ-IVA-01-2026', 'IVA', 1, 'Agenzia Entrate', 939.18, 939.18, 'Versamento IVA Gennaio', 1);

-- ============================================================
-- ACCOUNTING ENTRY LINES (Righe contabili – Must balance to zero)
-- ============================================================
-- Entry 1: Fattura Attiva #1 (DEBIT Clienti / CREDIT Ricavi + IVA)
INSERT INTO accounting_entry_lines (id, entry_id, account_id, line_type, amount, description) VALUES
(1, 1, 1, 'DEBIT', 1889.78, 'Clienti – Alfa Informatica'),  -- Assuming account_id 1 is Clienti (ATTIVO)
(2, 1, 4, 'CREDIT', 1549.00, 'Ricavi da vendite – software/hardware'),  -- Assuming 4 is Ricavi
(3, 1, 7, 'CREDIT', 340.78, 'IVA a debito – vendite');  -- Assuming 7 is IVA Passiva

-- Entry 2: Fattura Attiva #2 (DEBIT Clienti / CREDIT Ricavi + IVA)
INSERT INTO accounting_entry_lines (id, entry_id, account_id, line_type, amount, description) VALUES
(4, 2, 1, 'DEBIT', 242.78, 'Clienti – Beta Consulting'),
(5, 2, 4, 'CREDIT', 199.00, 'Ricavi da vendite – servizi'),
(6, 2, 7, 'CREDIT', 43.78, 'IVA a debito – servizi');

-- Entry 3: Incasso Fattura 1 (DEBIT Banca / CREDIT Clienti)
INSERT INTO accounting_entry_lines (id, entry_id, account_id, line_type, amount, description) VALUES
(7, 3, 3, 'DEBIT', 1889.78, 'Banca c/c – Incasso'),  -- Assuming 3 is Bank
(8, 3, 1, 'CREDIT', 1889.78, 'Clienti – Alfa Informatica');

-- Entry 4: Fattura Passiva #1 (DEBIT Costi + IVA / CREDIT Fornitori)
INSERT INTO accounting_entry_lines (id, entry_id, account_id, line_type, amount, description) VALUES
(9, 4, 2, 'DEBIT', 6450.00, 'Costi per acquisti – Hardware'),  -- Assuming 2 is Costi
(10, 4, 8, 'DEBIT', 1419.00, 'IVA attiva – acquisti'),  -- Assuming 8 is IVA Attiva
(11, 4, 5, 'CREDIT', 7869.00, 'Fornitori – HP Inc Italia');  -- Assuming 5 is Fornitori

-- Entry 5: Pagamento Fattura Passiva (DEBIT Fornitori / CREDIT Banca)
INSERT INTO accounting_entry_lines (id, entry_id, account_id, line_type, amount, description) VALUES
(12, 5, 5, 'DEBIT', 7869.00, 'Fornitori – HP Inc Italia'),
(13, 5, 3, 'CREDIT', 7869.00, 'Banca c/c – Pagamento');

-- Entry 6: IVA Settlement (DEBIT Erario / CREDIT Banca)
INSERT INTO accounting_entry_lines (id, entry_id, account_id, line_type, amount, description) VALUES
(14, 6, 9, 'DEBIT', 939.18, 'IVA dovuta – Liquidazione'),  -- Assuming 9 is IVA liability
(15, 6, 3, 'CREDIT', 939.18, 'Banca c/c – Pagamento IVA');
...
UNION ALL SELECT 'ACCOUNTING_ENTRIES', COUNT(*) FROM accounting_entries
UNION ALL SELECT 'ACCOUNTING_ENTRY_LINES', COUNT(*) FROM accounting_entry_lines
ORDER BY tabella;
