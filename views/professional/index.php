...
<section class="card" id="quality">
    <div class="card-header"><div><span class="section-kicker">Verifiche preliminari</span><h2>Controlli di coerenza</h2></div><a class="text-link" href="/workspace/onboarding">Configurazione aziendale <?= View::icon('chevron') ?></a></div>
...
<section class="professional-section" id="filings">
    <div class="section-heading"><div><span class="section-kicker">Preparazione e verifica</span><h2>Fascicoli adempimenti</h2><p>Prepara i fascicoli e verifica gli esiti. La trasmissione richiede la validazione e un servizio esterno configurato.</p></div></div>
    <div class="content-grid">
        <section class="card span-4">
        ...
        <section class="card data-card span-8">
            <div class="table-wrap"><table><thead><tr><th>Tipo</th><th>Periodo</th><th>Anomalie</th><th>Stato</th><th>Validazione / invio</th></tr></thead><tbody>
                <?php foreach ($filings as $row): ?><tr>
                    <td class="primary-cell"><?= View::e($filingTypes[$row['filing_type']] ?? $row['filing_type']) ?><small class="cell-subtitle"><?= View::e($row['schema_version'] ?: 'Schema non indicato') ?></small></td><td><?= (int) $row['period_year'] ?><?= $row['period_code'] ? ' · ' . View::e($row['period_code']) : '' ?></td><td><span class="badge <?= (int) $row['anomaly_count'] ? 'status-overdue' : 'status-active' ?>"><?= (int) $row['anomaly_count'] ?></span></td><td><span class="badge status-<?= View::e(strtolower((string) $row['status'])) ?>"><?= View::e(View::label($row['status'])) ?></span></td>
...
<section class="professional-section" id="banking">
    <div class="section-heading"><div><span class="section-kicker">Tesoreria assistita</span><h2>Import e riconciliazione bancaria</h2><p>Importa estratti conto CSV, CAMT.053 o MT940, verifica i duplicati e valuta gli abbinamenti proposti.</p></div></div>
    <div class="content-grid">
        <section class="card span-4">
    ...
    <section class="card data-card reconciliation-suggestions">
        ...
        <div class="table-wrap"><table><thead><tr><th>Affidabilità</th><th>Movimento</th><th>Pagamento proposto</th><th>Importo</th><th>Decisione</th></tr></thead><tbody>
            ...
            <?php if (!$suggestions): ?><tr><td colspan="5"><div class="table-empty"><strong>Nessuna proposta aperta</strong><small>Importa un estratto conto o ricalcola le proposte.</small></div></td></tr><?php endif; ?>
        </tbody></table></div>
    </section>
</section>
