...
<head>
    ...
    <link rel="stylesheet" href="/assets/app.css?v=6.1.2">
</head>
...
<main class="auth-shell">
    <section class="auth-visual">
        ...
        <div class="auth-visual-content">
            ...
            <div><span class="auth-overline">Business workspace</span><h1>La tua azienda,<br>in un unico spazio.</h1><p>Vendite, contabilità e operatività in un’unica piattaforma essenziale.</p></div>
            <small>© <?= date('Y') ?> Luna2 · Zen Software</small>
        </div>
    </section>
    <section class="auth-form-panel">
        <div class="auth-card">
            <div class="auth-card-head"><span class="mobile-auth-logo"><img class="mobile-auth-logo-image" src="/assets/logo-luna2.png?v=1" width="748" height="202" alt="Luna2"></span><span class="eyebrow">Area riservata</span><h2>Bentornato</h2><p>Accedi con le tue credenziali aziendali.</p></div>
            ...
            <p class="auth-security">Accesso riservato agli utenti autorizzati</p>
        </div>
    </section>
</main>
</body>
