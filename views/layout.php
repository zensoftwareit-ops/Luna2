...
<head>
    ...
    <link rel="stylesheet" href="/assets/app.css?v=6.7.0">
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="main-nav" aria-label="Menu principale">
            ...
            <?php if (Auth::isAdmin()): ?>
                ...
                <a class="nav-link<?= $active('/settings/domains') ?>" href="/settings/domains"><?= View::icon('globe') ?><span>Dominio personalizzato</span></a>
            <?php endif; ?>
