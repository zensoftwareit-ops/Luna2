...
<form method="post" action="/settings/modules">
    ...
    <div class="module-grid">
        <?php foreach ($features as $key => $feature): ?>
            ...
            <label class="module-card <?= $feature['enabled'] ? 'enabled' : '' ?>">
                <input class="module-checkbox" type="checkbox" name="modules[]" value="<?= View::e($key) ?>" <?= $feature['enabled'] ? 'checked' : '' ?>>
                ...
                <span class="module-state"><span class="switch-ui"></span><small><?= $feature['enabled'] ? 'Attivo' : 'Disattivato' ?></small></span>
