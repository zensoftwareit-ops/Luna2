...
return [
    'customers' => [
        ...
        'fields' => [
            ...
            'bank_name' => $text('Banca di appoggio Ri.Ba.'), 'bank_abi' => $text('ABI'), 'bank_cab' => $text('CAB'),
            'payment_terms' => $text('Descrizione pagamento'), 'payment_days' => ['label' => 'Giorni scadenza', 'type' => 'number'],
            'payment_month_end' => ['label' => 'Scadenza fine mese (FM)', 'type' => 'checkbox'],
            'payment_method_code' => $select('Modalità predefinita', ['MP05' => 'Bonifico', 'MP01' => 'Contanti', 'MP12' => 'Ri.Ba.', 'MP08' => 'Carta']),
            'credit_limit' => $decimal('Fido'),
    ...
    'suppliers' => [
        ...
        'fields' => [
            ...
            'iban' => $text('IBAN'), 'bank_name' => $text('Banca'), 'bank_abi' => $text('ABI'), 'bank_cab' => $text('CAB'),
            'payment_terms' => $text('Descrizione pagamento'), 'payment_days' => ['label' => 'Giorni scadenza', 'type' => 'number'],
            'payment_month_end' => ['label' => 'Scadenza fine mese (FM)', 'type' => 'checkbox'],
            'payment_method_code' => $select('Modalità predefinita', ['MP05' => 'Bonifico', 'MP01' => 'Contanti', 'MP12' => 'Ri.Ba.', 'MP08' => 'Carta']),
            'withholding_enabled' => ['label' => 'Soggetto a ritenuta', 'type' => 'checkbox'],
            'withholding_type' => $select('Tipo ritenuta', ['IRPEF' => 'IRPEF', 'INPS' => 'INPS', 'ENASARCO' => 'Enasarco', 'OTHER' => 'Altra']),
            'withholding_rate' => $decimal('Aliquota ritenuta %'), 'withholding_taxable_percent' => $decimal('Imponibile ritenuta %'),
            'withholding_cause' => $text('Causale pagamento'),
            'active' => ['label' => 'Attivo', 'type' => 'checkbox', 'default' => 1],
        ],
    ],
    'products' => [
