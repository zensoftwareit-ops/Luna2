...
/**
 * Entity class for OrdineRiga (Order Row)
 */
@Entity
@Table(name = "ordini_righe")
public class OrdineRiga implements Serializable {
    ...
    public BigDecimal getIvaImporto() { return ivaImporto; }
    public void setIvaImporto(BigDecimal ivaImporto) { this.ivaImporto = ivaImporto; }
    ...
    public String toString() {
        return "OrdineRiga{" + "id=" + id + ", descrizione='" + descrizione + '\'' + ", quantita=" + quantita + ", prezzoUnitario=" + prezzoUnitario + ", totaleRiga=" + totaleRiga + '}';
    }

    @Override
    public boolean equals(Object o) {
        if (this == o) return true;
        if (!(o instanceof OrdineRiga)) return false;
        OrdineRiga that = (OrdineRiga) o;
